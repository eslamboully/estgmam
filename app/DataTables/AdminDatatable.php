		...
		return $this->builder()
			...
			->parameters([
				...
				'buttons' => [
					...
					[
						'text' => '<i class="fa fa-trash-o"></i>' . __('adminpanel::adminpanel.delete_all'), 'className' => 'btn btn-danger delBtn', 'init' => 'function(api, node, config) {$(node).removeClass("dt-button")}',
					],
				],
				'language' => yajra_lang(),
			]);
