            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="desc_and_boat">
                    ...
                    {!! Form::open(['route' => 'trips.store' , 'files' => true]) !!}
                        ...
                        <div class="form-group">
                                  ...
                                  {!! Form::text( 'berth' , old('berth') , ['class' => 'form-control'] ) !!}
                        </div>

                        <div class="form-group">
                                  {!! Form::label('boat_number' ,  trans('trip::trip.boat_number')  ) !!}
                                  {!! Form::number( 'boat_number' , old('boat_number') , ['class' => 'form-control'] ) !!}
                        </div>


                        <div class="form-group">
                                  {!! Form::label('boat_title' ,  trans('trip::trip.boat_title')  ) !!}
                                  {!! Form::text( 'boat_title' , old('boat_title') , ['class' => 'form-control'] ) !!}
                        </div>

                        <div class="form-group">
                                  {!! Form::label('passengers' ,  trans('trip::trip.passengers')  ) !!}
                                  {!! Form::number( 'passengers' , old('passengers') , ['class' => 'form-control'] ) !!}
                        </div>
                ...
                <div class="tab-pane" id="dates_adnd_prices">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text( 'passenger_price' , old('passenger_price') , ['class' => 'form-control'] ) !!}
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text( 'day' , old('day') , ['class' => 'form-control'] ) !!}
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text( 'trip_hour' , old('trip_hour') , ['class' => 'form-control'] ) !!}
                        </div>
