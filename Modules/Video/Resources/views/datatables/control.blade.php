<a class="btn btn-primary" href="{{ route('videos.edit' , $id) }}">
	<i class="fa fa-edit"></i>
</a>

<a class="btn btn-danger" href="{{ route('videos.destroy' , $id) }}" data-toggle="modal" data-target="#del_admin{{ $id }}">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @php
          $video = trans('video::video.video')
        @endphp

        <h4>@lang('adminpanel::adminpanel.delete_this',[ 'type' => $video , 'name'=>$title])</h4>
      </div>
