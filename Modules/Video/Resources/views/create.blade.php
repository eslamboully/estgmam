            ...
            <div class="tab-content">
                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      {!! Form::text( $localeCode.'[title]' , old('title') , ['placeholder' => trans('video::video.title') , 'class' => 'form-control'] ) !!}
                    </div>

                    <div class="form-group">
                      {!! Form::label('desc' ,  trans('video::video.desc')  . ' ( ' . $properties['native'] . ' ) ' ) !!}
                      {!! Form::textarea( $localeCode.'[desc]' , old('desc') , ['placeholder' => trans('video::video.desc') , 'class' => 'form-control'] ) !!}
                    </div>
             ...
             @endforeach
                    ...
                    <div class="form-group">
                      ...
                      {!! Form::text( 'link' , old('link') , ['placeholder' => trans('video::video.link') , 'class' => 'form-control'] ) !!}
                    </div>
