<a class="btn btn-primary" href="{{ route('posts.edit' , $id) }}" >
  <i class="fa fa-edit"></i>
</a>

<a class="btn btn-danger" href="{{ route('posts.destroy' , $id) }}" data-toggle="modal" data-target="#del_admin{{ $id }}">
	<i class="fa fa-trash"></i>
</a>

{{--<a class="btn btn-warning" href="{{ route('posts.post-albums.create', $id) }}">--}}
