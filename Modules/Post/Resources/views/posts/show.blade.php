...
@section('content')
    <section class="content-header">
        <h1 style="font-family: 'Cairo', sans-serif;">
            @lang('admin::admin.trips')
            <small>@lang('admin::admin.control_panel')</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i> @lang('admin::admin.home')</a></li>
            <li><a href="{{route('trips.index') }}"><i class="fa fa-user-secret"></i> @lang('admin::admin.trips')</a></li>
            <li class="active">@lang('adminpanel::adminpanel.show')</li>
        </ol>
    </section>
