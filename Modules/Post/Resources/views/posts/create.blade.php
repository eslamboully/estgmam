...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('posts.index') }}"><i class="fa fa-user-secret"></i> @lang('post::post.posts')</a></li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="payment">
                    ...
                    <div class="form-group">
                        ...
                        <input type="image" id="image" src="{{ asset('/default.jpg') }}" style="width: 700px;height: 700px;">
                    </div>
...
{{--
 ...
 --}}
                            <div class="form-group">
                                ...
                                {!! Form::date( 'started_at' , old('started_at') , ['class' => 'form-control'] ) !!}
                            </div>

                            <div class="form-group">
                                {!! Form::label('ended_at' ,  trans('trip::trip.ended_at')  ) !!}
                                {!! Form::date( 'ended_at' , old('ended_at') , ['class' => 'form-control'] ) !!}
                            </div>
                            <div class="form-group">
                                <label>@lang('trip::trip.status')</label>
                                <select name="status" class="form-control">
                                    <option value="active">@lang('trip::trip.active')</option>
                                    <option value="pending">@lang('trip::trip.pending')</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="plan_id" class="form-control">
                                    @foreach($plans as $plan)
                                        <option value="{{ $plan->id }}">{{ $plan->date }}</option>
                                    @endforeach
                                </select>
                            </div>

                            <label>@lang('post::post.photo1')</label>
                            <input type="file" class="form-control" name="photo1">

                            <label>@lang('post::post.photo2')</label>
                            <input type="file" class="form-control" name="photo2">


                            <label>@lang('post::post.photo3')</label>
                            <input type="file" class="form-control" name="photo3">

                            <label>@lang('post::post.photo4')</label>
                            <input type="file" class="form-control" name="photo4">

                            <label>@lang('post::post.photo5')</label>
                            <input type="file" class="form-control" name="photo5">

                            <label>@lang('post::post.photo6')</label>
