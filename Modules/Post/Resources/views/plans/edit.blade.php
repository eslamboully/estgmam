                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                        <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="tab_{{ $localeCode }}">
                                            ...
                                            <div class="box">
                                                ...
                                                <!-- /.box-header -->
                                                <div class="box-body">
                                                    {!! Form::open(['route' => ['plans.update' , $plan->id]]) !!}

                                                    @method('put')
                                                    <div class="form-group">
                                                        {!! Form::label('date' ,  trans('post::post.date')  . ' ( ' . $properties['native'] . ' ) ' ) !!}
                                                        {!! Form::text( $localeCode.'[date]' , $plan->translate($localeCode)->date , ['placeholder' => trans('post::post.date') , 'class' => 'form-control'] ) !!}
                                                    </div>

                                                    <div class="form-group">
                                                        {!! Form::label('currency' ,  trans('post::post.currency')  . ' ( ' . $properties['native'] . ' ) ' ) !!}
                                                        {!! Form::text( $localeCode.'[currency]' , $plan->translate($localeCode)->currency , ['placeholder' => trans('post::post.currency') , 'class' => 'form-control'] ) !!}
                                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::text( 'money' , $plan->money , ['placeholder' => trans('post::post.money') , 'class' => 'form-control'] ) !!}
                                    </div>
